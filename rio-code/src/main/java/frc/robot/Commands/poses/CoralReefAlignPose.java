...
public class CoralReefAlignPose extends SequentialCommandGroup{
    ...
    public CoralReefAlignPose() {
        ...
        addCommands(
            new ConditionalCommand(new InstantCommand(() -> {Robot.robotMode.setDriveModeCommand(RobotMode.alignWithLeftReef);}), new InstantCommand(() -> {Robot.robotMode.setDriveModeCommand(RobotMode.alignWithRightReef);}), CoralReefAlignPose::isLeftBranchSelected),
