...
public class AlignWithAlgae extends Command{
    ...
    public void initialize() {
        ...
        targetPose = initialPosition.transformBy(CoralReefAlignPose.isLeftBranchSelected() ? new Transform2d(0, -0.19, new Rotation2d()) : new Transform2d(0, 0.19, new Rotation2d()));
