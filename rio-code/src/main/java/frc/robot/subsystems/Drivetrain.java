...
public class Drivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    private final PIDController choreoXController = new PIDController(3.3, 0, 0);
    private final PIDController choreoYController = new PIDController(3.3, 0, 0);
    private final PIDController choreoOmegaController = new PIDController(3.8, 0, 0);
